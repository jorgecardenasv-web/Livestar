      ...
      <div className="container relative mx-auto z-10 min-h-[100dvh] max-h-[900px] flex">
        <div className="w-full flex items-center mt-16 md:mt-0">
          <div className="w-full flex flex-col md:flex-row items-center justify-end gap-4 md:gap-8">
            <div className="text-center md:text-right w-full md:max-w-lg lg:max-w-xl xl:max-w-2xl 2xl:max-w-3xl md:ml-auto px-4 md:px-0">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-end">
                <Link
                  href="/cotizar"
                  className="inline-flex font-bold h-14 items-center justify-center rounded-lg bg-white px-6 text-[#223E99] hover:text-primary transition-colors w-full sm:w-auto"
                >
