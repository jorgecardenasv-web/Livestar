...
export const QuoteCard = ({
  ...
  // TODO: Debido a la falta de elemento multimedia se quitan los modales y se cambia el cursor por defecto en los botones
  return (
    <button
      onClick={() => openModal(title)}
      className="w-full cursor-default border lg:w-80 h-auto lg:h-80 bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 relative group"
    >
