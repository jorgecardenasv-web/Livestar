...
export default function MoreInformationModal({
  ...
  const rawIndividualPrices = JSON.parse(individualPricesJson);
  console.log("rawIndividualPrices: ", rawIndividualPrices);
//   console.log("rawIndividualPrices:-------> ", rawIndividualPrices);

//   const transformedData = Object.entries(rawIndividualPrices).reduce(
