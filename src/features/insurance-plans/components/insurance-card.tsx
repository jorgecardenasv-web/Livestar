...
import { InsuranceCompany, InsurancePlan } from "../types";
...
export const InsuranceCard: React.FC<InsuranceCardProps> = ({ company, plan, paymentType, isRecommended }) => {
  ...
  const handleInterestClick = () => {
    const planInfo = {
      ...
      coberturaDental: plan.benefits.dentalCoverage ? 'Incluida' : 'No incluida',
  ...
  return (
    <div className={`bg-white w-64 border rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg ${
      ...
      <div className="p-6">
        <Image src={company.logo} width={128} height={128} alt={company.name} className="w-32 h-16 mx-auto mb-4" />
        ...
        <div className="space-y-4">
          ...
          <div className="text-center">
            ...
            <div className="font-bold text-zinc-900">${plan.deductible.toLocaleString()}</div>
          </div>
          <div className="flex items-center justify-center">
            <svg className="w-5 h-5 text-blue-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
            </svg>
            <span className="text-sm text-zinc-500">$0 deducible por accidente</span>
          </div>
          <div className="text-center">
            <div className="text-sm text-zinc-500">Coaseguro</div>
            <div className="font-bold text-zinc-900">{(plan.coInsurance * 100).toFixed(0)}%</div>
          </div>
          <div className="text-center">
            <div className="text-sm text-zinc-500">Tope coaseguro</div>
            <div className="font-bold text-zinc-900">${plan.coInsuranceCap?.toLocaleString()}</div>
          </div>
          <div className="text-center">
