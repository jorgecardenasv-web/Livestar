...
export const ListButtonsAdvisors = ({
  ...
  const handleDeleteAdvisor = async (): Promise<void> => {
    ...
    if (isOperationConfirmed)
      return showNotification("¡Asesor creado exitosamente!", "success");
    ...
    <>
      ...
      >
        ...
        <p className="mt-2 leading-6 text-tremor-default text-tremor-content dark:text-dark-tremor-content">
          Esta acción no se puede deshacer. Una vez eliminado, el registro será
          eliminado permanentemente de la base de datos. Por favor, asegúrate de
          que realmente deseas proceder con esta acción.
        </p>
